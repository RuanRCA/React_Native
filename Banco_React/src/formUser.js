...
import {doc , getDocs , getDoc  , onSnapshot , setDoc , collection , addDoc , updateDoc} from 'firebase/firestore'
...
<TextInput
 ...
 {isEditing != "" ?(
  ...
  <Text style={styles.buttonText}>Cadastrar</Text>
      ...
      renderItem={({item})=><UsersList data={item} handlerEdit={(item)=>editUser(item)}/>}
      />
